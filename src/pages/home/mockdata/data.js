const homeData = {
  ...
  cards: [
    { id: 'c1', icon: '👐', title: 'Be a Hero', description: "Share meals you won't use and help neighbors in need.", cta: 'Share Now' },
    { id: 'c2', icon: '🍽️', title: 'Find Food', description: 'See available meals in your area and claim what you need.', cta: 'Browse' },
    { id: 'c3', icon: '📦', title: 'How it Works', description: 'Simple steps: post, connect, and deliver.', cta: 'Learn More' }
  ],
  map: {
    count: '123,456'
  },
  values: [
    { id: 'v1', icon: '🌱', title: 'Sustainability', description: 'Reduce waste and support local sharing.' },
    { id: 'v2', icon: '🤝', title: 'Community', description: 'Neighbors helping neighbors.' },
    { id: 'v3', icon: '🔒', title: 'Safety', description: 'Guidelines to ensure safe sharing.' }
  ],
  testimonials: [
