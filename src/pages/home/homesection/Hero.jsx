...
const Hero = ({ stats = {}, story = {} }) => {
  return (
    <section className="relative overflow-hidden h-96 md:h-[480px]">
  ...
  <Navigationlinks />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center flex flex-col items-center justify-center h-full">
        ...
        {/* Story title will be displayed inside the quote card (green text) */}

        {/* Story quote box (title moved inside and styled green) */}
        {story?.quote && (
          <div className="max-w-2xl w-full">
            <div className="mx-auto bg-black/55 text-white rounded-3xl px-6 py-6 shadow-lg border border-white/10">
              {/* small green title inside the card */}
              {story?.title && (
